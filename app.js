...
function applyInitialViewport(force = false) {
  ...
  const zoomOutAllowance = 0.7;      // allow further zoom-out than fit      // how much further out than "fit" the user can go
  const startOutAllowance = 0.5;     // start more zoomed out than fit     // start slightly more zoomed out than fit     // start at the max zoom-out level (same as min zoom)
